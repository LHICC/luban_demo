...
|                  |                                                                                                                                                          |                                        |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| ×登录网址（**请提供**）   | **页面上可点击或切换 用户名密码登录/GIHTUB登录/LDAP**登录（样式可从简）                                                                                                             |                                        |
| √数据库中用户（**请使用**） | 普通用户                                                                                                                                                     | 用户名：user\_1 密码： user\_1                |
|                  | √EDITOR                                                                                                                                                  | 用户名：editor\_1 密码：editor\_1             |
|                  | PRODUCT\_ADMIN                                                                                                                                           | 用户名：adm\_1 密码：adm\_1                   |
| ×GITHUB          | 登录后，给EDITOR角色                                                                                                                                            |                                        |
| √LDAP（**请使用**）   | 普通用户                                                                                                                                                     | 用户名：ldap\_user\_1 密码：ldap\_user\_1     |
|                  | EDITOR                                                                                                                                                   | 用户名：ldap\_editor\_1 密码：ldap\_editor\_1 |
|                  | PRODUCT\_ADMIN                                                                                                                                           | 用户名：ldap\_adm\_1 密码：ldap\_adm\_1       |
| √几个命令行（bash）：    | **通过CURL**获取ACCESS TOKEN **通过CURL添加产品\[通过ACCESS TOKEN鉴权]**&#xA;&#xA;**通过CURL**修改产品\[通过**ACCESS TOKEN**鉴权]&#xA;&#xA;**通过CURL**删除产品\[通过**ACCESS TOKEN**鉴权] |                                        |
